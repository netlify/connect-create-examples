...
```
NETLIFY_CONNECT_ENDPOINT="http://wordpressite.com/graphql"
```
...
```bash
NETLIFY_CONNECT_ENDPOINT="[WPGraphQL Endpoint]"
```
...
| ---------------------------------- | -------- | -       | ------------------------------------------------- |
| NETLIFY_CONNECT_ENDPOINT         | Yes      | -       | WordPress Netlify Connect Endpoint|
